...
import 'package:spartan/features/wallet/presentation/address_book/select_address_dialog.dart';
import 'package:spartan/features/wallet/presentation/wallet_navigation_bar/components/asset_dropdown_menu_item.dart';
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      '$_estimatedFee ${getTosTicker(network)}',
                      style: context.titleMedium?.copyWith(
                        color: context.moreColors.mutedColor,
                      ),
                    ),
