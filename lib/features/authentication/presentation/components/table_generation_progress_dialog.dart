...
class TableGenerationProgressDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final progressReport = ref.watch(progressReportStreamProvider);

    final progressValue = progressReport.asData?.value.progress ?? 0.0;

    var displayStep = '';
    switch (progressReport.asData?.value.step) {
