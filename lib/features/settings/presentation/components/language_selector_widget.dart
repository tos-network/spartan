...
import 'package:spartan/features/settings/domain/locale_translate_name.dart';
...
class LanguageSelectorWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ExpansionTile(
      ...
      title: Text(loc.language, style: context.titleLarge),
      subtitle: Text(
        translateLocaleName(locale),
        style: context.titleMedium!.copyWith(color: context.colors.primary),
      ),
      children: List<ListTile>.generate(AppResources.countryFlags.length, (
        index,
      ) {
        return ListTile(
