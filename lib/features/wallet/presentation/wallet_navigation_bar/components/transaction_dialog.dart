...
import 'package:spartan/features/wallet/domain/multisig/multisig_participant.dart';
import 'package:spartan/features/wallet/domain/transaction_review_state.dart';
import 'package:spartan/features/wallet/presentation/wallet_navigation_bar/components/burn/burn_review_content.dart';
import 'package:spartan/features/wallet/presentation/wallet_navigation_bar/components/multisig/delete_multisig_review_content.dart';
import 'package:spartan/features/wallet/presentation/wallet_navigation_bar/components/transfer/transfer_review_content.dart';
...
class _TransactionDialogState extends ConsumerState<TransactionDialog> {
  ...
  Future<void> _broadcastTransfer(WidgetRef ref) async {
    ...
    try {
      ...
      final tosMessage = (e).message.split("\n")[0];
      ref.read(snackBarQueueProvider.notifier).showError(tosMessage);
    } catch (e) {
      talker.error('Cannot broadcast transaction: $e');
