...
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/burn_entry_content.dart';
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/coinbase_entry_content.dart';
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/deploy_contract_entry_content.dart';
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/incoming_entry_content.dart';
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/invoke_contract_entry_content.dart';
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/multisig_entry_content.dart';
import 'package:spartan/features/wallet/presentation/history_navigation_bar/components/outgoing_entry_content.dart';
...
class _TransactionEntryScreenState
  ...
  Widget build(BuildContext context) {
    ...
    Uri url;
    switch (network) {
      case Network.mainnet || Network.stagenet || Network.devnet:
        url = Uri.parse(
